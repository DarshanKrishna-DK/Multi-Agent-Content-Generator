...
st.set_page_config(page_title="EZHostz - Multi Agent Content Generation", page_icon="🧠", layout="wide")

st.title("Content Generation with Multi Agent CrewAI")
st.markdown("Welcome to the EZHostz demo! This app demonstrates how CrewAI agents can collaborate to generate content efficiently.")
...
# Footer section
st.markdown("---")
st.markdown("Built with ❤️ by EZHostz")
